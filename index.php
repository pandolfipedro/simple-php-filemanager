...
Copyright Pedro Pandolfi (@pandolfipedro)
...
<title>simple-php-filemanager</title>
...
<?php endif; ?>
	...
	function renderBreadcrumbs(path) {
		var base = "",
			$html = $('<div/>').append( $('<a href=#>Início</a></div>') );
...
<div id="top">
   <?php if($allow_create_folder): ?>
	<form action="?" method="post" id="mkdir" />
		<label for=dirname>Criar nova pasta</label><input id=dirname type=text name=name value="" />
